...
func (s *LwdStreamer) GetLightdInfo(ctx context.Context, in *walletrpc.Empty) (*walletrpc.LightdInfo, error) {
	if common.DarksideEnable {
		return common.DarksideGetLightdInfo(), nil
	}
...
func (s *DarksideStreamer) DarksideSetState(ctx context.Context, state *walletrpc.DarksideState) (*walletrpc.Empty, error) {
	if !common.DarksideEnable {
